...
CloudVar は PSAN Network によって個人で開発・運営されています。
もしこのプロジェクトが役に立ち、継続的な開発を応援したいと思っていただけるなら、以下のリンクからご支援（投げ銭）をいただけると非常に励みになります！

- **PayPayで寄付する**: [こちらをクリック](https://qr.paypay.ne.jp/p2p01_mB6A3Y2Y7N5Y3X3E)（※あなたのリンクに差し替えてください）

支援金は、公式サーバーの維持費や、新機能開発のためのコーヒー代として大切に使わせていただきます。
